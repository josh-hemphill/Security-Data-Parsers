...
| [RegisteredID](SAN.Firsts/RegisteredID) { get; } | Gets the first registered ID in the SAN extension. |
| [Rfc822Name](SAN.Firsts/Rfc822Name) { get; } | Gets the first RFC 822 name in the SAN extension. |
| [UniformResourceIdentifier](SAN.Firsts/UniformResourceIdentifier) { get; } | Gets the first uniform resource identifier in the SAN extension. |
| [X400Address](SAN.Firsts/X400Address) { get; } | Gets the first X.400 address in the SAN extension. |
